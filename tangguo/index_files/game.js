(function (t) {
    ...
    h.getGameConfig = function () {
        ...
        return SpilGames(["JSLib"], function (e) {
            var n = e.get("current.html5.integration.info");
    ...
    f.isA10 = function () {
        return /app.46465.com/.test(window.location.host)
    },
    f.getRole = function () {
    ...
    d.getLocalConfig = function (t) {
        ...
        var e = {
            html5: {
                ...
                info: t.html5.info || {},
                settings: t.html5.objectSettings || {},
                features: {
                    achievements: t.html5.achievements || !1,
                    gameSidePanel: t.html5.gameSidePanel || !1,
                    highscores: t.html5.highscores || !1,
                    recommendedGames: t.html5.recommendedGames || !1
                }
            },
            user: {
                ...
                configar: {
                    branding: {
                        ...
                        logo: {
                            label: "logo",
                            image: "img/logo.png",
                            url: "http://app.46465.com/html5/gzh",
                            style: "",
                            width: "202",
                            height: "50",
                            mime: "image/png",
    ...
    r.prototype.emit = function (t) {
        if (!this.IS_MASTER) throw Error("Only the master environment can emit html5 events");
        if (!this.moduleReady) throw Error("This method cannot be called before the API is loaded");
        if (t === this.gameState) throw Error("The html5 is already in state: `" + t + "`");
    ...
    i.prototype._setupEvents = function () {
        ...
        this.isMaster ? (SpilGames(["JSLib"], function (e) {
            e.subscribe("ad.request.accepted", function (e) {
                !0 === e && (SpilGames("html5.ad.accepted", !0), t._postMessage(!0, void 0, "ad.request.accepted"))
            }),
            e.subscribe("ad.complete", function () {
                t._postMessage("", "", "ad.complete")
            })
        }), this.messenger.subscribe("html5.ad.request", this._triggerAd, this)) : (this.messenger.subscribe("ad.request.accepted", this._onAdAccepted, this), this.messenger.subscribe("ad.complete", this._onAdCompleted, this))
    },
    i.prototype._triggerAd = function () {
        SpilGames("html5.ad.request")
    },
    ...
    i.prototype.request = function (t, e) {
        ...
        this.messenger._postMessage(void 0, void 0, "html5.ad.request"),
    ...
    o.prototype.init = function (t) {
        ...
        var e = this.data && this.data.html5 && this.data.html5.applicationId ? this.data.html5.applicationId : null,
            n = new Date,
    ...
    o.prototype.trackGamePlay = function (t) {
        ...
        var e = this.gamePlayTracking.gid,
            ...
            i = this._createEventObject("html5", "gameplay", {
                applicationId: e,
                start: n,
                host: r
            });
    ...
    o.prototype.trackTimeInGame = function (t) {
        ...
        var e = this.timeInGameTracking.gid,
            ...
            r = this._createEventObject("html5", "heartbeat", {
                applicationId: e,
                start: n
            });
    ...
    o.prototype.startInternalTracking = function (t, e, n) {
        var r = this,
            i = 6e4,
            o = function (t) {
                if (!t) throw "Could not save the time in html5"
            };
    ...
    a.prototype.getLogo = function (t) {
        ...
        t && "object" == typeof t && (r = f.validateSchema(i, t), r.error && (n.error = r.error)),
        n
    },
    ...
    a.prototype._tagUrl = function (t, e) {
        var n, r, i, o = this.data && this.data.portal ? this.data.portal : {},
            a = this.data && this.data.html5 ? this.data.html5 : {},
    ...
    c.prototype._postMessage = function (t, e, n) {
        var r, i;
        r = f.isArray(t) && "function" == typeof t[t.length - 1] ? this._callbacks.push(t.pop()) - 1 : e,
        i = new s({
            type: n || "jslib",
            callbackId: r,
            data: t
    ...
    c.prototype._handleMessage = function (t) {
        ...
        return a && (e = a.type, n = a.callbackId, r = a.data, i = this._callbacks[n] || !1, this.IS_MASTER ? "jslib" === e ? ("Array" === r.constructor.name && r.push(function (t) {
                o._postMessage(t, n)
            }), this._callJSLib.apply(this, r)) : "ugapi" === e ? this._handleUGARequest(t) : this.publish(e, r) : this.IS_SLAVE && ("function" == typeof i ? (delete this._callbacks[n], i(r)) : "jslib" !== e && this.publish(e, r))),
        !1
    },
    ...
    p.prototype.loadAPI = function (t) {
        ...
        return !0 === this.isReady ? (window.console && window.console.log && console.log("WARNING: Detected multiple executions of GameAPI.loadAPI(). This method should only be executed once per page load!"), t(r)) : (this.__.messenger._postMessage(["log.gameapi.loadapi.start", {
            ...
            null], null, "log"), this.IS_STANDALONE ? d.setupStandaloneMode(function (t) {
                r.__.dataStore._setCache(n(t)),
                e(t)
            }) : this.IS_MASTER ? d.getGameConfig().then(function (t) {
                d.getBrandingConfig(t).then(function (i) {
                    t && !t.isError && (t.branding = i.branding, r.__.dataStore._setCache(n(t))),
                    e(t)
                })
    ...
    "function" == typeof define && define.amd && define("GameAPI", m),
    t.GameAPI = m
})(window);