...
function createAnimation(e, t, n, r, i, s, o) {
    ...
    for (var a = n; a <= r; ++a) {
        ...
        if (f == undefined || f == null || isNaN(f)) console.log("ERROR");
        var l = 1 + (a == r ? o : 0);
        for (var c = 0; c < l; ++c)
        u.push(f)
    }
...
function createFontFrames(e) {
    ...
    for (var n = 0; n < t.length; ++n) {
        ...
        var i = t.charAt(n);
        if (e.animations[r.toString()]) e.animations[i] = e.animations[i.toUpperCase()] = e.animations[r.toString()]
    }
}
...
var FieldObject = function (e) {
    ...
    t.prototype.getFileName = function () {
        ...
        if (this.bonusType == 4) return "bonus color";
        var e = t.assetNames[this.colorType] + t.bonusNames[this.bonusType];
        if (!this.isBonus && this.isHighValue) e += " bonus";
        return e
    };
    ...
    t.prototype.setCache = function (e, t, n) {
        ...
        if (!CACHE_ENABLED || e && this.bonusType == 4) return;
    ...
    t.prototype.playBonusAnimation = function () {
        if (this.bonusType == 4) this.level.objects.push(new SinglePlayObject(this.sprite.x, this.sprite.y, "color bonus", 37, this.level.gemDestroyLayer, 67, 61, ANIM_SCALE));
        else {
...
var Match3Level = function (e) {
    ...
    t.prototype.starMoveAwardMode = function () {
        ...
        for (var h = 0; h < c; ++h) {
            ...
            for (var S = 0; S < E; ++S) {
                ...
                b = Math.max(N, b);
                if (x == i || a.indexOf(x) == -1) x.prepareToClear(N, f[h], -1, x == i);
                y.push(x)
            }
    ...
    t.prototype.trySpawnBonus = function (e) {
        ...
        while (true) {
                    ...
                    for (var b = 0; b < g; b++) {
                        if (r != b) {
                            ...
                            if (m != -1) {
                                var E = w.length;
                                var S = m;
                                if (S < t.MIN_LINE_SIZE) S = 0;
                                var x = E - (m + 1);
                                if (x < t.MIN_LINE_SIZE) x = 0;
                                h[r] -= (E - (S + x)) * 1.1
                            }
                        }
                    }
            ...
            if (g <= 1 || e.length < t.MIN_LINE_SIZE) break
        }
    };
    ...
    t.prototype.combinateBonuses = function (e) {
        ...
        var i = e.length;
        for (r = 0; r < i; ++r) {
            if (e[r].object && e[r].object.isBonus) n.push(e[r])
        }
        if (n.length > 1) {
    ...
    t.prototype.spawnBonus = function (e, t, n, r) {
        ...
        for (i = 0; i < 80; ++i) {
            ...
            if (u.object && !u._isBlock && !u.object.isBonus && !u.object.isWaitingForDestruction && !u.object.isMoving && !u.isWaitingForClear && !u.object.isPushable && !u.object.isHighValue) {
                ...
                if (!f) {
                    if (r == null) this.objects.push(new BonusIndicator(t, n, u, e));
    ...
    t.prototype.getBonusGroup = function (e, t, n) {
            ...
            for (s = -2; s <= 2; ++s) {
                for (u = -2; u <= 2; ++u) {
                    ...
                    if (f >= 0 && l >= 0 && l < this.fieldHeight && f < this.fieldWidth) {
                        ...
                        if (c.isStable() || c.isBreakable) i.push(c)
                    }
                }
            }
            break;
        ...
        case 5:
            ...
            for (u = 0; u < this.fieldHeight; ++u) {
                a = this.cells[e.x][u];
                if (a.isStable() || o.isBreakable) i.push(a)
            }
            break;
        case 6:
            for (s = 0; s < this.fieldWidth; ++s) {
        ...
        case 8:
            ...
            while (v > 0 && p > 0 && m > 0) {
                ...
                c = d[g];
                i.push(c);
                if (c != e) c.object.setBonusType(Math.random() > .5 ? 1 : 2);
                d.splice(g, 1);
                v--;
                p--
            }
        ...
        case 9:
            ...
            while (v > 0 && p > 0 && m > 0) {
                ...
                c = d[g];
                i.push(c);
                if (c != e) c.object.setBonusType(3);
                d.splice(g, 1);
                v--;
                p--
            }
    ...
    t.prototype.getBonusDelay = function (e) {
        var t = 0;
        if (e == 4) t += 20 / 30;
        else if (e != 0 && e < 8) t += BonusDestroyAnimation.TIME;
        return t
    };
    ...
    t.prototype.onMouseDown = function (e, t) {
        ...
        if (i && i.length >= 3) {
            ...
            if (r.x < 0 || r.y < 0 || r.x >= this.fieldWidth || r.y >= this.fieldHeight) return;
    ...
    t.prototype.update = function (e) {
        ...
        if (this.isLocked || this.isEnded) this.timeSinceLastAction = 0;
        else {
            this.timeSinceLastAction += e;
            if (this.timeSinceLastAction > 3 && !MenuManager.instance.isOnTutorial()) this.playHint();
        ...
        if (CACHE_ENABLED) {
            ...
            for (var r = 0; r < this.fieldHeight; ++r) {
                var i = this.cells[n][r];
                if (i.cacheUpdateState > CellObject.CACHE_NONE) this.drawCache(i)
            }
        }
    ...
    t.prototype.checkIfComboExists = function () {
        ...
        for (var t = 0; t < this.fieldWidth; ++t)
        for (var e = 0; e < this.fieldHeight; ++e)
        if (this.isGoodForClick(this.cells[t][e])) i.push(this.cells[t][e]);
        var s = i.length;
        this.isLocked = true;
        var o = 80;
        var u = false;
...
var App = function () {
    ...
    e.prototype.loadApi = function () {
        console.log(apiInstance.Branding.getLink("more_games").error);        
    ...
    e.prototype.onDown = function (t) {
        ...
        if (e.level && !r && !i) e.level.onMouseDown(t.stageX, t.stageY);
        else if (i) e.level.onHudDown(t.stageX, t.stageY);
    ...
    e.prototype.onUp = function (e) {
        ...
        if (t) t.onUp(e.stageX, e.stageY);
        e.nativeEvent && e.preventDefault && e.preventDefault() && e.stopPropagation()
    };
    e.prototype.resize = function () {
    	var width=null;
    	var height=WGtangguo.getStageHeight();
    	var top=WGtangguo.getStageTop();
    	
        var t =width|| window.innerWidth,
        ...
        if (isOrientationLocked()) {
                ...
                e.CURRENT_SHIFT = d / c;
                r.canvas.style.top = this.backStage.canvas.style.top = (top||d) + "px";
                var m = (t - h) / 2;
    ...
    e.prototype.setVisibilityListener = function () {
        ...
        if (t in document) document.addEventListener("visibilitychange", n);
        else if ((t = "mozHidden") in document) document.addEventListener("mozvisibilitychange", n);
        else if ((t = "webkitHidden") in document) document.addEventListener("webkitvisibilitychange", n);
        else if ((t = "msHidden") in document) document.addEventListener("msvisibilitychange", n);
    ...
    e.prototype.onVisibilityChange = function () {
        if (SoundsManager.instance.musicPaused) SoundsManager.instance.resumeMusic();
        else SoundsManager.instance.pauseMusic()
    };
    e.SCREEN_W = 640;
    e.SCREEN_H = 712 + 30;
    e.FULL_SCREEN_H = 960;
...
var Hud = function (e) {
    ...
    t.prototype.pauseLevel = function () {
        if (MenuManager.instance.target.sprite.parent || Match3Level.instance.isWaitingForTarget && !Match3Level.instance.isHardLocked || MenuManager.instance.current == MenuManager.instance.tutorial) return;
        this.level.pause();
        SoundsManager.instance.playSound("pause")
    };
    t.prototype.updateBar = function (e) {    	
    	//WGtangguo.updateMyScore();
...
//    	})
    ...
    t.prototype.movePoinPointerToButton = function (e) {
        ...
        var i = r[1] - (275 + 50);
        var s = r[1] + 50;
        if (this.scrollSprite.y + i < 0) this.scroll(-i + 100, 300, 0);
        else if (this.scrollSprite.y + s > App.SCREEN_H + App.SHIFT_H) this.scroll(App.SCREEN_H + App.SHIFT_H - s - 100, 300, 0);
        this.updatePointerData();
...
var CharMenu = function (e) {
    ...
    t.prototype.update = function (t) {
        e.prototype.update.call(this, t);
        if (this.char.visible) this.char.update(t);
        ...
        if (this.char.currentFrame == 114) this.char.visible = false;
...
var MainMenu = function (e) {
    ...
    t.prototype.onEpisodeDown = function () {
        if (this.crossButton) {
            ...
            window.open("http://www.duopao.com/games/more", "_blank")
        }
    };
...
var PauseLikeMenu = function (e) {
    function t() {
        ...
        if (this.brandLogo.sprite) this.brandLogo.sprite.y = App.ACTUAL_H - 40 + (App.FULL_SCREEN_H - App.ACTUAL_H) / 2;
        this.moreGames = new MoreGamesButton(t, 90, App.CURRENT_SHIFT + App.SCREEN_H - 30, 1);
        if (this.moreGames.sprite) this.moreGames.sprite.y = App.ACTUAL_H - 60 + (App.FULL_SCREEN_H - App.ACTUAL_H) / 2
    }
    __extends(t, e);
    t.prototype.show = function () {
        e.prototype.show.call(this);
        ...
        if (this.clickables.indexOf(this.brandLogo) == -1) this.clickables.push(this.brandLogo);
        if (this.clickables.indexOf(this.moreGames) == -1) this.clickables.push(this.moreGames);
        if (this.brandLogo.sprite) this.brandLogo.sprite.visible = true;
        if (this.moreGames.sprite) this.moreGames.sprite.visible = true
    };
    t.prototype.hide = function () {
        var t = this;
        ...
        if (this.brandLogo.sprite) this.brandLogo.sprite.visible = false;
        if (this.moreGames.sprite) this.moreGames.sprite.visible = false
    };
...
var CreditsMenu = function (e) {
    function t() {
        ...
        this.dataTexts = [];
        var n = ["http://www.duopao.com/games/more"];
        for (var r = 0; r < n.length; ++r) {
            for (var i = 0; i < 2; i++) {
                if (i == 0) continue;
...
var BlockClearTarget = function (e) {
    ...
    t.prototype.onLevelGenerated = function () {
        ...
        for (var t = 0; t < App.level.fieldHeight; ++t) {
            var n = App.level.cells[e][t];
            if (n.isBreakable || n.isColorBlocked)++this.blocksToRemove
        }
    };
...
var LevelData = function () {
    function e(t, n, r) {
        ...
        this.cellData = s[0];
        this.targetData =4;// parseInt(s[1]);
        this.customData =100000;// parseInt(s[2]);
        this.customData2 =100000;// parseInt(s[3]);
        this.movesLeft =1000;// parseInt(s[7]); change by fan
        this.starValues = [parseInt(s[4]), parseInt(s[5]), parseInt(s[6])];
        if (s.length > 8) {
            this.pushPositions = [];
            var o = s[8];
            for (var u = 0; u < o.length && u < Match3Level.LEVEL_W; ++u)
            if (parseInt(o.charAt(u)) == 1) this.pushPositions.push(u)
        }
        for (var i = 0; i < Match3Level.LEVEL_W; ++i) {
            for (var a = 0; a < Match3Level.LEVEL_H; ++a) {
                var f = Match3Level.getCellDataType(this.cellData, i, a);
                if (f == 2) this.hasWhiteChoco = true;
                if (f == 3) this.hasBlackChoco = true
            }
        }
...
var CellObject = function (e) {
    ...
    t.prototype.setMark = function (e) {
        ...
        this.marksLeft = e;
        App.game.needToUpdateBack = true;
        if (t > 0 && e < t && this.mark && e >= 0) this.level.objects.push(new CookieTweenSprite(this.mark.x, this.mark.y, e));
        if (this.marksLeft <= 0) {
        ...
        r.regX = r.regY = 4;
        if (r.parent == null) App.level.marks.addChild(r);
        this.mark = r
    };
    t.prototype.reset = function () {
    ...
    t.prototype.removeBlock = function () {
        ...
        if (this.breakCountLeft <= 0) {
            if (t) this.level.objects.push(new SinglePlayObject(this.block.x + this.level.tileSize / 2, this.block.y + this.level.tileSize / 2, "color wall", 18, this.level.blockDestroyLayer, 53, 53, ANIM_SCALE));
            else if (this.lastBlockSet == 2) this.level.objects.push(new SinglePlayObject(this.block.x + this.level.tileSize / 2, this.block.y + this.level.tileSize / 2, "chocolate destroy", 15, this.level.blockDestroyLayer, 53, 65, ANIM_SCALE));
            else this.level.objects.push(new SinglePlayObject(this.block.x + this.level.tileSize / 2, this.block.y + this.level.tileSize / 2, "chocolate white destr", 18, this.level.blockDestroyLayer, 57, 58, ANIM_SCALE));
            this._isBlock = false;
            removeClip(this.block);
            this.block = null
    ...
    t.prototype.clearCell = function (e) {
        ...
        if (this.object && (!this.object.isPushable || !this.level.isActive) && !this.isColorBlocked) {
            if (this.level.isActive) {
                if (!(this.object.bonusType >= 1 && this.object.bonusType <= 4)) Match3Level.pool.getDestroyAnimation(this.object.colorType, this.object.sprite.x, this.object.sprite.y, this);
                ...
                if (this.object.isBonus) {
                    ...
                    } else if (n == 4) SoundsManager.instance.playSound("bonus_color");
    ...
    t.prototype.tryPlayScoreAnimation = function () {
        if (this.scoreToAdd > 0) {
            ...
            WGtangguo.updateMyScore(this.scoreToAdd);
...
var Preloader = function () {
    ...
    e.prototype.onApiLoaded = function (e) {
        ...
        {
            src: "assets/preloader/progressbar top.jpg",
...
var LogoObject = function (e) {
    function t(t, n, r, i) {
        ...
        if (o) {
            ...
            t.addChild(o);
            this.sprite = o;
            if (apiInstance.Branding.getLogo().action) this.callback = function () {
    ...
    t.prototype.onLogoClick = function () {
        ...
        if (apiInstance.Branding.getLogo().action) apiInstance.Branding.getLogo().action();
        createjs.Tween.get(this.sprite, {
            loop: false
        }).wait(0).to({
...
var MoreGamesButton = function (e) {
    function t(t, n, r, i) {
        ...
        if (o) {
            ...
            t.addChild(o);
            this.sprite = o;
            if (apiInstance.Branding.getLink("more_games").action) this.callback = function () {
                return s.onLogoClick()
            }
        }
    }
    ...
    t.prototype.onLogoClick = function () {
        if (!this.sprite) return;
        if (apiInstance.Branding.getLink("more_games").action) apiInstance.Branding.getLink("more_games").action();
        createjs.Tween.get(this.sprite, {
            loop: false
        }).wait(0).to({
            scaleX: 1.2 * this.initScale,
...
var FirstGroupTapTutorial = function (e) {
    function t() {
        e.call(this);
        if (App.episode <= 1) this.tapCells.push(cjp(5, 1), cjp(5, 2), cjp(5, 3), cjp(4, 2), cjp(6, 2), cjp(6, 3));
        else this.tapCells.push(cjp(2, 5), cjp(3, 4), cjp(3, 5), cjp(4, 4), cjp(4, 5), cjp(4, 6), cjp(5, 6));
        var t = new createjs.Container;
